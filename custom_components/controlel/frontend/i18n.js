  ...
  const MESSAGES = {
    en: {
      ...
      water: {
        ...
        current_state: "Current state",
        current_lead: "Assessment and sensor condition are reported separately; unknown or unavailable evidence is never shown as dry or OK.",
        sensor_condition: "Sensor condition",
        sensor_sub: "Latest reported moisture evidence",
        area: "Area",
        zone_named: "Zone: {name}",
        zone_unknown: "Zone not reported",
        incident: "Incident",
        incident_active: "Active wet incident",
        incident_none: "No active incident",
        incident_silenced: "Incident outputs silenced",
        incident_not_silenced: "Incident outputs not silenced",
        processing: "Processing",
        siren_count: "Configured sirens",
        ...
        assessment: {
          confirmed: "Confirmed",
          indeterminate_grace: "Indeterminate (grace)",
          disabled: "Disabled",
        },
        actions: {
          silence: "Silence incident",
      ...
      "wizard.water": {
        ...
        step_sirens: "Sirens (optional)",
        step_settings: "Settings",
        step_review: "Review",
        discovery_title: "Discover Home Assistant objects",
        discovery_lead: "Load a backend discovery snapshot and recommendations for Water Safety bindings.",
        area_title: "Choose the protected area",
        area_lead: "Select the Home Assistant area this Water Safety module monitors.",
        sensor_title: "Moisture sensor",
        sensor_lead: "Select the moisture sensor that provides wet/dry evidence for this area.",
        notifications_title: "Notification targets",
        notifications_lead: "Select one or more notification services used for wet, recovery and fault messages.",
        sirens_title: "Sirens (optional)",
        sirens_lead: "Optionally select siren outputs. You may continue without selecting any siren.",
        settings_title: "Water Safety settings",
        settings_lead: "Tune grace timing and optional custom notification messages.",
        critical_sensor: "Critical sensor",
        grace_seconds: "Unavailable grace (seconds)",
        fault_repeat_seconds: "Fault notification repeat (seconds)",
        message_wet: "Wet message override",
        message_recovery: "Recovery message override",
        message_fault: "Fault message override",
        role_moisture_sensor: "Moisture sensor",
        role_notification: "Notification target",
        role_siren: "Siren output",
        lifecycle_title: "Setup lifecycle",
        lifecycle_lead: "Run each step explicitly: save the draft, validate it, canonicalize it, then activate it.",
        review_persisted_lead: "Review the persisted draft, then run validation, canonicalization and activation explicitly.",
        canonicalized_not_active: "This draft was canonicalized but is not active yet. Activate it explicitly when ready.",
        activated_revision: "Active revision: {revision}",
      },
    },
    ...
    cs: {
      ...
      navigation: {
        ...
        modules: "Moduly",
        heating: "Topení",
        water_safety: "Ochrana proti úniku vody",
      ...
      action: {
        ...
        configure_water: "Nakonfigurovat ochranu proti úniku vody",
        ...
        open_water_safety: "Otevřít ochranu proti úniku vody",
      ...
      water: {
        ...
        current_state: "Aktuální stav",
        current_lead: "Posouzení a stav senzoru jsou hlášeny odděleně; neznámé nebo nedostupné údaje se nikdy nezobrazují jako sucho nebo OK.",
        sensor_condition: "Stav senzoru",
        sensor_sub: "Poslední hlášený údaj o vlhkosti",
        area: "Místnost",
        zone_named: "Zóna: {name}",
        zone_unknown: "Zóna nehlášena",
        incident: "Incident",
        incident_active: "Aktivní incident vlhkosti",
        incident_none: "Žádný aktivní incident",
        incident_silenced: "Výstupy incidentu ztišeny",
        incident_not_silenced: "Výstupy incidentu nejsou ztišeny",
        processing: "Zpracování",
        siren_count: "Nakonfigurované sirény",
        ...
        not_configured_title: "Ochrana proti úniku vody není nakonfigurována",
        not_configured_message: "Pro tento záznam Controlel zatím nebyl aktivován modul ochrany proti úniku vody.",
        state: {
          ok: "OK",
          wet: "Detekována vlhkost",
          sensor_fault: "Porucha senzoru",
          disabled: "Vypnuto",
          sensor_dry: "Sucho",
          sensor_wet: "Detekována vlhkost",
        },
        assessment: {
          confirmed: "Potvrzeno",
          indeterminate_grace: "Nedostatečně určeno (tolerance)",
          disabled: "Vypnuto",
        },
        actions: {
          silence: "Ztišit incident",
          disable: "Vypnout modul",
          enable: "Zapnout modul",
          test_notification: "Test notifikace",
          test_siren: "Test sirény",
          pending: "Probíhá…",
        },
      },
      diagnostics: {
      ...
      settings: {
        ...
        water_safety_config: "Konfigurace ochrany proti úniku vody",
        water_safety_config_desc: "Senzor vlhkosti, oznámení a sirény pro ochranu proti úniku vody.",
      ...
      "wizard.water": {
        step_discovery: "Objevování",
        step_area: "Místnost",
        step_sensor: "Senzor",
        step_notifications: "Notifikace",
        step_sirens: "Sirény (volitelné)",
        step_settings: "Nastavení",
        step_review: "Kontrola",
        discovery_title: "Objevit objekty Home Assistant",
        discovery_lead: "Načtěte snímek objevování a doporučení backendu pro ochranu proti úniku vody.",
        area_title: "Vyberte chráněnou místnost",
        area_lead: "Zvolte místnost Home Assistant, kterou tento modul sleduje.",
        sensor_title: "Senzor vlhkosti",
        sensor_lead: "Vyberte senzor vlhkosti pro sucho/mokro v této místnosti.",
        notifications_title: "Cíle notifikací",
        notifications_lead: "Vyberte služby notifikací pro mokro, návrat a poruchu.",
        sirens_title: "Sirény (volitelné)",
        sirens_lead: "Volitelně vyberte sirény. Můžete pokračovat bez výběru sirény.",
        settings_title: "Nastavení ochrany proti vodě",
        settings_lead: "Upravte toleranci a volitelné texty notifikací.",
        critical_sensor: "Kritický senzor",
        grace_seconds: "Tolerance nedostupnosti (s)",
        fault_repeat_seconds: "Opakování notifikace poruchy (s)",
        message_wet: "Vlastní text při mokru",
        message_recovery: "Vlastní text při návratu",
        message_fault: "Vlastní text při poruše",
        role_moisture_sensor: "Senzor vlhkosti",
        role_notification: "Cíl notifikace",
        role_siren: "Siréna",
        lifecycle_title: "Životní cyklus nastavení",
        lifecycle_lead: "Proveďte každý krok explicitně: uložit, validovat, kanonizovat a aktivovat.",
        review_persisted_lead: "Zkontrolujte uložený koncept a poté explicitně spusťte validaci, kanonizaci a aktivaci.",
        canonicalized_not_active: "Koncept byl kanonizován, ale ještě není aktivní. Aktivujte jej explicitně.",
        activated_revision: "Aktivní revize: {revision}",
      },
    },
  };

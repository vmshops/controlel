...
def validate_wheel(wheel: Path, *, distribution: str, version: str) -> None:
    ...
    with zipfile.ZipFile(wheel) as archive:
        ...
        required = {
            ...
            "controlel/application/ports/notification_delivery_port.py",
            "controlel/application/services/operational_event_recorder.py",
            "controlel/application/services/operational_event_stream.py",
            "controlel/application/services/user_activity_composer.py",
            "controlel/application/services/user_activity_stream.py",
            "controlel/application/services/notification_planner.py",
            "controlel/application/services/notification_processor.py",
            "controlel/application/services/notification_policy.py",
            ...
            "controlel/application/setup/activation.py",
            "controlel/application/configuration/heating_setup_adapter.py",
            "controlel/application/configuration/canonical_v3.py",
            "controlel/application/configuration/canonical_v3_authoring.py",
            "controlel/application/configuration/canonical_v3_conversion.py",
            "controlel/application/configuration/canonical_v3_lifecycle.py",
            "controlel/application/configuration/canonical_v3_migration.py",
            "controlel/application/configuration/canonical_defaults.py",
            "controlel/application/configuration/__init__.py",
            "controlel/application/configuration/water_safety_setup_adapter.py",
            "controlel/application/services/water_safety_projector.py",
            "controlel/application/state/water_safety_diagnostics.py",
            "controlel/application/water_safety/__init__.py",
            "controlel/application/water_safety/model.py",
            "controlel/application/water_safety/ports.py",
            "controlel/application/water_safety/runtime.py",
            ...
            "controlel/frontend_api/__init__.py",
            "controlel/frontend_api/v1/__init__.py",
            "controlel/frontend_api/v1/models.py",
            "controlel/frontend_api/v1/provider.py",
            "controlel/domain/operating_mode/__init__.py",
            "controlel/domain/operational_events/__init__.py",
            "controlel/domain/user_activities/__init__.py",
            "controlel/domain/notifications/__init__.py",
            ...
            "controlel/domain/water_safety/__init__.py",
            "controlel/domain/water_safety/model.py",
            ...
            "controlel/infrastructure/home_assistant/water_safety_discovery.py",
            "controlel/infrastructure/home_assistant/water_safety_setup_host.py",
...
def validate_sdist(sdist: Path, *, distribution: str, version: str) -> None:
    ...
    with tarfile.open(sdist, mode="r:gz") as archive:
        ...
        required = {
            ...
            "src/controlel/application/ports/notification_delivery_port.py",
            ...
            "src/controlel/application/services/user_activity_composer.py",
            "src/controlel/application/services/user_activity_stream.py",
            "src/controlel/application/services/notification_planner.py",
            ...
            "src/controlel/application/setup/activation.py",
            "src/controlel/application/configuration/heating_setup_adapter.py",
            "src/controlel/application/configuration/canonical_v3.py",
            "src/controlel/application/configuration/canonical_v3_authoring.py",
            "src/controlel/application/configuration/canonical_v3_conversion.py",
            "src/controlel/application/configuration/canonical_v3_lifecycle.py",
            "src/controlel/application/configuration/canonical_v3_migration.py",
            "src/controlel/application/configuration/canonical_defaults.py",
            "src/controlel/application/configuration/__init__.py",
            "src/controlel/application/configuration/water_safety_setup_adapter.py",
            "src/controlel/application/services/water_safety_projector.py",
            "src/controlel/application/state/water_safety_diagnostics.py",
            "src/controlel/application/water_safety/__init__.py",
            "src/controlel/application/water_safety/model.py",
            "src/controlel/application/water_safety/ports.py",
            "src/controlel/application/water_safety/runtime.py",
            ...
            "src/controlel/frontend_api/__init__.py",
            "src/controlel/frontend_api/v1/__init__.py",
            "src/controlel/frontend_api/v1/models.py",
            "src/controlel/frontend_api/v1/provider.py",
            "src/controlel/domain/operating_mode/__init__.py",
            "src/controlel/domain/operational_events/__init__.py",
            "src/controlel/domain/user_activities/__init__.py",
            "src/controlel/domain/notifications/__init__.py",
            ...
            "src/controlel/domain/water_safety/__init__.py",
            "src/controlel/domain/water_safety/model.py",
            ...
            "src/controlel/infrastructure/home_assistant/water_safety_discovery.py",
            "src/controlel/infrastructure/home_assistant/water_safety_setup_host.py",
        }

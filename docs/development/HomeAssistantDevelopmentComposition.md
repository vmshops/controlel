...
```bash
cd /mnt/c/GitHub/Controlel/controlel-core-0.18-release
...
The result is `dist/development/controlel-dev-0.18.0.zip`. Its
`composition.json` binds the SHA-256 of both contained artifacts:

- `core/controlel-0.18.0-py3-none-any.whl`

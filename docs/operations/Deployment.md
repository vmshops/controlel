...
Public-package validation instead installs `controlel==0.18.0` into a separate
...
Core versions `0.1.0` through `0.18.0` are immutable public releases. Any core
correction requires a new version; never rebuild

...
`controlel==0.17.0` package and ships canonical configuration v3 Configure,
...
- Required Core package: exactly `controlel==0.17.0` from public PyPI.
...
Core 0.17.0 is public and its wheel and sdist identities match the immutable
